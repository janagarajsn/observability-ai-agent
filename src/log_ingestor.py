        ...
        for i in range(0, len(logs), LOG_BATCH):
            ...
            for log in batch:
                ...
                doc = Document(
                    ...
                    metadata={
                        **{k: log.get(k) for k in ["namespace","pod","application","level","timestamp"]}, 
                        "vector": vector,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--collection", type=str, default="aks_logs", help="Qdrant collection name")
